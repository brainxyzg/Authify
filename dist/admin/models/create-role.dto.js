...
exports.CreateRoleResponseDto = exports.CreateRoleDto = void 0;
...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^[a-zA-Z0-9_]+$/, { message: 'Name must contain only letters, numbers, or underscores' }),
